...
static const uint32_t BitsIoLdd1_PIN_MASK_MAP[7U] = {
   0x02U, 0x04U, 0x08U, 0x10U, 0x20U, 0x40U, 0x80U
...
LDD_TDeviceData* BitsIoLdd1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  /* GPIOC_PDDR: PDD|=0xFE */
  GPIOC_PDDR |= GPIO_PDDR_PDD(0xFE);                                   
  /* Set initialization value */
  /* GPIOC_PDOR: PDO&=~0xFE */
  GPIOC_PDOR &= (uint32_t)~(uint32_t)(GPIO_PDOR_PDO(0xFE));                                   
