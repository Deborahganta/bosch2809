...
**     Date/Time   : 2022-10-11, 14:52, # CodeGen: 1
**     Abstract    :
...
#define BitsIoLdd1_PORT_MASK 0xFEU     /*!< Mask of the allocated pin from the port */
#define BitsIoLdd1_PORT_VALID_VALUE_MASK 0x7F /*!< Mask of the allocated pins from the port as the first pin would be zero i.e. valid bits to be set in method PutVal */
#define BitsIoLdd1_PIN_ALLOC_0_MASK 0x02 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_INDEX 1U /*!< The index of the first allocated pin from the port */
