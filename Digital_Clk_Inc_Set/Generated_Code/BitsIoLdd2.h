...
#define BitsIoLdd2_MODULE_BASE_ADDRESS FPTD_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd2_PORTCONTROL_BASE_ADDRESS PORTD_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd2_PORT_MASK 0x1EU     /*!< Mask of the allocated pin from the port */
...
#define BitsIoLdd2_PIN_ALLOC_0_MASK 0x02 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd2_PIN_ALLOC_0_INDEX 1U /*!< The index of the first allocated pin from the port */
